...
public class EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    // Determine whether scroll operation should be captured
    private boolean enabled = true;
    // Handler for scroll event
    private OnEndlessScrollListener mScrollListener;

    RecyclerView.LayoutManager mLayoutManager;

    public EndlessRecyclerViewScrollListener(RecyclerView.LayoutManager layoutManager, OnEndlessScrollListener scrollListener) {
    ...
    public void onScrolled(RecyclerView view, int dx, int dy) {
        if (enabled) {
            ...
            if (!loading && (lastVisibleItemPosition + visibleThreshold) > totalItemCount) {
                currentPage++;
                mScrollListener.onLoadMore(currentPage, totalItemCount, view);
                loading = true;
            }
        }
    }
    ...
    // Call this setter to determine whether scroll action should be done
